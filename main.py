...
wage_and_happiness_by_country = wage_and_happiness.groupby("Country").mean()
wage_average_per_country = wage_and_happiness_by_country["Value"].mean()
happiness_average_per_country = ["Happiness Score"].mean()

print(f"Country with largest average wages: {wage_average_per_country}.nlargest(10)")
print(f"Country with smallest average wages: {wage_average_per_country}.nsmallest(10)")
print(f"Country with largest average happiness: {happiness_average_per_country}.nlargest(10)")
print(f"Country with smallest average happiness: {happiness_average_per_country}.nsmallest(10)")
